...
class ArchiveMovie extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <Paper className ="containerHover show" style = {{margin: '2px', display: 'none'}}>
                ...
                <div className="middleHover">
                    <Button onClick={()=>{this.props.onRemoveMovieArchive(this.props.movie)}} variant ="contained" color = "primary" className="textHover">Remove</Button>
...
export default connect(null, mapDispatchToProps)(ArchiveMovie)